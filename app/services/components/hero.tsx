        ...
        >
            ...
            <div className="w-full px-[5%] xl:px-[8%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10 flex-grow mt-[-40px]">
                ...
                <div className="flex flex-col items-center text-center lg:items-start lg:text-left justify-start pt-14 lg:pt-0 mt-2 lg:mt-[-80px]">
                    <h2 className="text-[#ececec] text-[15.5px] md:text-[36px] lg:text-[40px] font-normal leading-tight mb-2 lg:mb-2 tracking-wide">
                        Looking for a
                    </h2>
                    <h1 className="text-white text-[25.5px] md:text-[52px] lg:text-[58px] font-bold leading-[1.2] lg:leading-[1.1] mb-0 lg:mb-2 tracking-wide">
                        Technology Partner
                    </h1>
                    <h1 className="text-white text-[25.5px] md:text-[50px] lg:text-[56px] font-bold leading-[1.2] lg:leading-[1.1] mb-5 lg:mb-6 tracking-wide">
                        You Can Truly Rely On?
                    </h1>

                    <p className="text-[#a5a5af] text-[13px] md:text-[18px] max-w-[45rem] font-normal leading-[1.7] lg:leading-[1.6] mt-2 lg:mt-12 mb-7 w-[95%] px-5 lg:px-0 mx-auto lg:mx-0">
                    ...
                    <button suppressHydrationWarning className="group flex items-center relative h-12 w-fit cursor-pointer">
                        {/* LEFT ICON CIRCLE */}
            ...
            {/* 3 Bottom Cards */}
            <div className="w-full px-0 md:px-[5%] xl:px-[8%] mx-auto mt-[-30px] md:mt-6 mb-0 md:mb-8 relative z-20">
                <div className="w-full bg-[#1b1c1e]/90 md:bg-[#1c1d20]/95 backdrop-blur-[40px] md:rounded-2xl border-t border-[#ffffff15] md:border md:border-white/30 flex flex-col md:flex-row shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
                    ...
                    {/* Card 1 */}
                    <div className="flex-1 flex flex-row items-center p-6 md:p-8 lg:p-10 xl:p-12 border-b border-[#ffffff10] md:border-b-0 md:border-r md:border-white/20 relative overflow-hidden group">
                    ...
                    {/* Card 3 */}
                    <div className="flex-1 flex flex-row items-center p-6 md:p-8 lg:p-10 xl:p-12 relative overflow-hidden group">
                        <div className="absolute -inset-2 bg-gradient-to-r from-blue-500/0 via-blue-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        <div className="w-[30px] h-[30px] md:w-[48px] md:h-[48px] min-w-[30px] min-h-[30px] md:min-w-[48px] md:min-h-[48px] rounded-full bg-[#3b82f6] flex items-center justify-center mr-5 shadow-sm">
                            <Check className="w-[14px] h-[14px] md:w-6 md:h-6 text-white stroke-[4]" />
                        </div>
