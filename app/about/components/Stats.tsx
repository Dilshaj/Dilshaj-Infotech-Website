...
export default function Stats() {
    return (
        <section className="relative w-full bg-black py-16 md:py-24 px-6 md:px-12 lg:px-20 overflow-hidden">
            <div className="relative z-10 w-full max-w-[1700px] mx-auto flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-20">
                ...
                <div className="w-full lg:w-[45%] space-y-6 relative py-12 lg:py-20 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <div className="w-full lg:w-[55%] p-6 sm:p-8 md:p-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl relative z-10">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-4">
                        {stats.map((stat, index) => (
                            <div
                                key={index}
                                className="group relative flex flex-col items-center justify-center p-8 bg-zinc-900/40 backdrop-blur-sm border border-zinc-800/50 rounded-2xl transition-all duration-300 hover:border-[#31B5FE]/50 hover:bg-zinc-800/80"
