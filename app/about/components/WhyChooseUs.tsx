...
export default function WhyChooseUs() {
    return (
        <section className="bg-black py-24 px-6 md:px12 lg:px-20 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="relative group rounded-[27px] overflow-hidden border border-zinc-800/50 aspect-[4/3]">
                            <Image
