...
export default function Build() {
    return (
        <section className={`${poppins.className} w-full relative bg-white pt-24 pb-12 overflow-hidden flex flex-col items-center`}>
            <h2 className="text-[24px] xs:text-[26.5px] sm:text-[32px] md:text-[40px] lg:text-[52px] font-medium text-center tracking-normal sm:tracking-[0.1em] lg:tracking-[0.15em] text-[#1a1a1a] mb-[5px] lg:mb-[-60px] z-20 md:whitespace-nowrap sm:scale-y-105 w-full max-w-[342px] md:max-w-none mx-auto flex flex-col md:block items-center justify-center gap-1 md:gap-0 leading-[1.3] md:leading-[1.4]">
            ...
            <div className="relative z-30 flex flex-col items-center max-w-[900px] text-center mt-[-30px] sm:mt-[-50px] md:mt-[-160px] lg:mt-[-220px] px-4">
                <p className="text-[#333333] text-[15px] sm:text-[16px] md:text-[18px] leading-[1.7] md:leading-[1.8] font-medium mb-8 sm:mb-10 px-4">
