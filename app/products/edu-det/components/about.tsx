...
export default function About() {
    return (
        <section className={`${poppins.className} w-full bg-white text-black py-20 relative`} style={{ paddingBottom: "100px" }}>
            ...
            <div className="max-w-[1300px] mx-auto w-full px-4 lg:px-8 flex flex-col lg:flex-row justify-between items-start mt-24">
                {/* Left Side */}
                <div className="max-w-[550px] ml-0 lg:ml-2 text-left">
                ...
                <div className="grid grid-cols-2 gap-4 lg:gap-5 mt-12 lg:mt-0 flex-shrink-0 w-full lg:w-auto">
                    <div className="bg-[#f8f9fc] rounded-[24px] w-full min-h-[160px] lg:w-[180px] lg:h-[160px] flex flex-col justify-center items-center p-3 text-center">
                    ...
                    <div className="bg-[#000000] text-white rounded-[24px] w-full min-h-[160px] lg:w-[180px] lg:h-[160px] flex flex-col justify-center items-center shadow-lg p-3 text-center">
