...
export default function Hero() {
    return (
        <section
            className="relative w-full min-h-[500px] md:min-h-screen py-20 flex items-center bg-[#06102B] bg-center bg-no-repeat overflow-hidden font-sans"
            style={{ 
                backgroundImage: "url('/products/bike-rider-images/bike-rider-images/herobbg.png')",
                backgroundSize: 'cover',
                backgroundPosition: 'center'
            }}
        >
            {/* Subtle overlay focused on the left to ensure text readability but keep the bikes and cars clear */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#06102B]/90 via-[#06102B]/40 to-transparent z-0"></div>

            <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 flex flex-col md:flex-row items-center justify-between">

                {/* Left Side Content */}
                <div className="w-full md:w-[60%] lg:w-[50%] flex flex-col justify-center">
                    <div>
                        <h1 className={`${poppins.className} text-[32px] sm:text-[38px] md:text-[42px] lg:text-[52px] xl:text-[60px] font-bold text-white leading-[1.1] md:leading-[1.1] tracking-tight mb-6 md:mb-8`}>
                        ...
                        <p className="text-[#B3BCE5] text-[16px] sm:text-[18px] md:text-[18px] lg:text-[20px] font-medium mb-10 max-w-[600px] leading-[1.6]">
                    ...
                    <div>
                        <button className="flex items-center group relative h-12 w-fit cursor-pointer md:mt-4">
